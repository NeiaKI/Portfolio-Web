...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    title: {
      default: "Febiyanto Rizki Qurbandi — Software Engineer",
      template: "%s | Febiyanto Rizki Qurbandi",
    },
    description: t("heroDesc"),
    keywords: ["Febiyanto Rizki Qurbandi", "nateeki", "Software Engineer", "Next.js", "React", "TypeScript", "Go", "Tangerang", "Indonesia"],
    ...
    openGraph: {
      ...
      title: "Febiyanto Rizki Qurbandi — Software Engineer",
      description: t("heroDesc"),
      images: [{ url: `/api/og?title=Febiyanto+Rizki+Qurbandi&desc=Software+Engineer+%C2%B7+Linux+Enthusiast`, width: 1200, height: 630, alt: "Febiyanto Rizki Qurbandi Portfolio" }],
    },
    twitter: {
